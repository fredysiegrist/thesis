...
ComputeNEC	\quad Effective number of codons \\							% I guess all functions need require(seqinr)
RelativeAdaptiveness	\quad Compute Relative Adaptiveness	 \\			% Handle warnings
