%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%		Master Thesis in Bioinformatics and 
%       Computational Biology
%       Statistical Analysis of Coding Sequences
%		Fredy Siegrist 2016
%		99-119-380
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\include{main/chW_figures_tables}
\include{main/ch2_setup}
\include{main/ch3_Rpackage}
\include{main/ch4_transcription}
\include{main/ch5_vignette}
\include{main/ch6_outlook}
%\include{main/chX_math}
\include{main/ch7_installation}
